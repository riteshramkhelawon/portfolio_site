 window.sr = ScrollReveal();
        ...
        sr.reveal('.contact-name', {
            duration: 2000,
            delay: 200,
            origin: 'bottom',
            distance: '100px'
        });
        sr.reveal('.contact-email', {
            duration: 2000,
            delay: 250,
            origin: 'bottom',
            distance: '100px'
        });
        sr.reveal('.contact-subject', {
            duration: 2000,
            delay: 300,
            origin: 'bottom',
            distance: '100px'
